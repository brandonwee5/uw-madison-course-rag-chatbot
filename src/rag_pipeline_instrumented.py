...
def stage1_pdf_to_markdown(pdf_file="data/report-gradedistribution-2024-2025spring.pdf", 
                            output_file="data/processed/fullgrades.md"):
...
def stage2_markdown_to_chunks(input_file="data/processed/fullgrades.md", 
                               text_file="data/processed/chunks.txt",
                               json_file="data/processed/chunks.json"):
...
def stage3_chunks_to_embeddings(chunks_file="data/processed/chunks.json",
                                 embeddings_txt="data/processed/embeddings.txt",
